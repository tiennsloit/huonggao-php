...
<div class="box_container"> 
  ...
  <div class="right_gh">
    ...
    <form method="post" name="frm_order" id="frm_order" action="" enctype="multipart/form-data" onsubmit="return check();">
        ...
        <div class="item_lienhe"><input placeholder="Họ và tên" name="hoten" type="text" id="hoten" value="<?php if($_POST['hoten']!='')echo $_POST['hoten'];else echo $info_user['ten']?>"/></div>
        ...
        <div class="item_lienhe"><input placeholder="Điện thoại" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" name="dienthoai" id="dienthoai" value="<?php if($_POST['dienthoai']!='')echo $_POST['dienthoai'];else echo $info_user['dienthoai']?>" type="text"  /></div>
        ...
        <div class="item_lienhe"><input placeholder="Địa chỉ" name="diachi" type="text" id="diachi" value="<?php if($_POST['diachi']!='')echo $_POST['diachi'];else echo $info_user['diachi']?>" /></div>

        <div class="item_lienhe"><input placeholder="Email" name="email" type="text" id="email" value="<?php if($_POST['email']!='')echo $_POST['email'];else echo $info_user['email']?>" /></div>
        
        <div class="item_lienhe"><textarea name="noidung" placeholder="Nội dung" cols="50" rows="1" ><?=$_POST['noidung']?></textarea></div>
      </form>
      </div>
