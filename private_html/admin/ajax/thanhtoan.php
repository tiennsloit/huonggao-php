<?php
	...
	$ten_input=(string)$_POST['ten'];
	$diachi_input=(string)$_POST['diachi'];
	$dienthoai_input=(string)$_POST['dienthoai'];
	$email_input=(string)$_POST['email'];
	$noidung_input=(string)$_POST['noidung'];
	$phuongthuc_input=(string)$_POST['phuongthuc'];
