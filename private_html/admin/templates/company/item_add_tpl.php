...
<form name="supplier" id="validate" class="form" action="index.php?com=company&act=save" method="post" enctype="multipart/form-data">
    ...
    <div class="title"><img src="./images/icons/dark/users.png" alt="" class="titleIcon" />
       ...
       <?php } ?>
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <textarea  rows="8" cols="" title="Mã nhúng bản đồ" class="tipS" name="bando" id="bando"><?=@$item['bando']?></textarea>
            </div>
            <div class="clear"></div>
        </div>  
    ...
    <div class="form-editor content-item-map none">
     ...
     <div class="widget">
        ...
        <div class="formRow">
            <label>Code thêm (trên thẻ head)</label>
            <div class="formRight">
                <textarea rows="8" cols="" class="tipS description_input" name="codetren" original-title="Nhập thêm các code muốn thêm vào website như code chat,google analytics..."><?=@$item['codetren']?></textarea>
            </div>
        <div>

        <div class="formRow">
            <label>Code thêm (trong thẻ body)</label>
            <div class="formRight">
...
<?php  /* ?>
<script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyAWeT1XJvt4gCc7I1cYEna_BupB6G9C5A4"></script>
<script type="text/javascript">
